...
# for step 3 on windows provide full path to openssl.cnf in a string eg
#  openssl req  -passin pass:1111 -new -key server.key -out server.csr -subj "/CN=localhost" -config "D:\Program Files\OpenSSL-Win64\bin\cnf\openssl.cnf"
...
# on windows run 4 without -extensiosn flag
